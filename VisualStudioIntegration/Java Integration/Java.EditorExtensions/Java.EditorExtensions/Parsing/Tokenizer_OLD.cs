    ...
    public sealed partial class Tokenizer {
        ...
        private Token ReadNumber(int start) {
            ...
            if (start == '0') {
                ...
                } else if (_langVersion >= JavaLanguageVersion.V26) {
        ...
        private Token ReadName() {
            ...
            if (ch == 'i') {
                ...
                ch = NextChar();
                if (ch == 'i') {
                    if ((_langVersion >= JavaLanguageVersion.V26 || _withStatement) && NextChar() == 't' && NextChar() == 'h' && !IsNamePart(Peek())) {
                ...
                if (ch == 'n') {
                    ...
                    if ((_langVersion >= JavaLanguageVersion.V26 || _withStatement) && !IsNamePart(Peek())) {
