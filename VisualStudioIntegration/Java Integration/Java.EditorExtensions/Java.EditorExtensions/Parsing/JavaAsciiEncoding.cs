...
{
    /// <summary>
    /// Simple implementation of ASCII encoding/decoding.  The default instance (JavaAsciiEncoding.Instance) is
    ...
    /// </summary>
    [Serializable]
    sealed class JavaAsciiEncoding : Encoding {
        ...
        internal static Encoding MakeNonThrowing() {
            ...
            Encoding enc = (Encoding)new JavaAsciiEncoding().Clone();
