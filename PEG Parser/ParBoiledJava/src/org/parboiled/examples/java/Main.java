...
public class Main {
    ...
    protected void run(String[] args) {
        ...
        //ParsingResult<Object> parsingResult = new ReportingParseRunner<Object>(compilationUnit).run(sourceText);
        ...
        if (parsingResult.hasErrors()) {
        	System.out.printf(ErrorUtils.printParseErrors(parsingResult));
        }
        
        System.out.printf(printTree(parsingResult.parseTreeRoot, new ToStringFormatter<Node<Object>>()));
